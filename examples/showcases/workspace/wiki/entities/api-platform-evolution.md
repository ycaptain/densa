...
- GraphQL gateway for analytics surface — deferred to Q4
  (see exit Trigger 2 in [[2026-05-13-meeting-api-style-decision-summary]]).
...
- **API style for identity service**: option (D) hybrid (gRPC
  ...
  ADR lands; see [[2026-05-13-meeting-api-style-decision-summary]]
...
- [[2026-05-13-meeting-api-style-decision-summary]] — the analysis
