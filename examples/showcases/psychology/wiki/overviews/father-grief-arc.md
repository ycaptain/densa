...
arc_start: 2026-02-04
arc_status: active
tags: [grief, father, bereavement, primary-arc, six-week-arc, turning-point]
aliases: ["father grief arc", "Mark's bereavement arc", "Eldridge grief case"]
status: active
compiled_against: 2
migration_history:
  - from: 1
    ...
    on: 2026-05-26
    mode: in-place
    notes: 'type theme → overview'
---

# Father-grief arc

> [!important] Overview one-liner (v1 theme/arc)
...
```mermaid
timeline
    title Father-grief arc — observed timeline
    2026-02-04 : Father dies suddenly (MI)
    2026-02-04 to 03-30 : Logistics phase
                       : Funeral, probate, apartment
                       : Three weekends at mother's
                       : Adrenaline / functional mode
    2026-02-23 to 04-02 : Symptom emergence
                       : 3:40 a.m. early waking
                       : Chest-band somatic anchor
                       : Two-of-me work mode
                       : PCP visit, PHQ-9 = 14
    2026-04-02 : Session 1 (Reyes)
                       : Three-layer formulation
                       : 4P framing
    2026-04-16 : Session 2 (Reyes)
                       : IFS introduced, foreman named
                       : Cottage-cheese Exile contact (~60s)
    2026-04-23 : Psychiatry consult (Han)
                       : Scales baseline
    ...
    2026-05-09 : Mother phone call (TURNING POINT)
                       ...
                       : Mother's disclosure re father
                       : Guilt-distortion lifted
    2026-05-14 : Session 4 (Reyes)
                       : Partial unburdening
                       : Cottage-cheese now "tender"
                       : Meaning-reconstruction begins
    2026-05-21 : Psychiatry f/u (Han)
                       : (rescheduled from 05-07)
                       : Pending in worked example
```
