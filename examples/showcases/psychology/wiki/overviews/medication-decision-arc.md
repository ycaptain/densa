...
arc_start: 2026-04-23
arc_status: active
tags: [medication, psychiatry, ssri, trazodone, deferral, decision-making, cross-clinical]
aliases: ["medication arc theme", "the medication question", "SSRI vs process arc"]
status: active
compiled_against: 2
migration_history:
  - from: 1
...
```mermaid
timeline
    title Medication-decision arc
    2026-04-23 : First psychiatry consult
                : No medication initiated
                : SSRI deferred to mid-July
                : Trazodone held; revisit 05-07
    2026-05-07 : Originally scheduled trazodone decision
                : Rescheduled (client work conflict)
    2026-05-14 : Therapy session 4
                : Client leaning to defer trazodone too
                : Sleep beginning to shift marginally
                : Reyes recommends client raise with Han
    2026-05-21 : Psychiatry f/u (rescheduled)
                : Trazodone decision pending
                : Outcome not yet documented
    2026-07 (mid) : SSRI decision review
                : Marker: avoidance-cluster loosening
                : If avoidance has softened, SSRI may not be needed
```
