...
triggers: ["mother's incoming call", "mother's voicemail", "anticipation of mother's grief", "Sarah's gentle prompting"]
first_observed: 2026-04-02
last_observed: 2026-05-14
severity: medium
tags: [avoidance, attachment, mother, grief, dismissing, relational]
aliases: ["avoiding mom", "voicemail-default", "maternal-contact avoidance"]
status: active
compiled_against: 2
migration_history:
  - from: 1
...
```mermaid
flowchart LR
    A["Weeks 1-7<br/>(pre-therapy)<br/>voicemail default"] --> B["Session 1, 04-02<br/>noticed, not prescribed"]
    B --> C["Session 2, 04-16<br/>protector named<br/>20-min call held"]
    C --> D["Psychiatry, 04-23<br/>indexed by PCL-5<br/>tracked marker"]
    D --> E["05-09 phone call<br/>client-initiated<br/>70 min, regret disclosed"]
    E --> F["Session 4, 05-14<br/>pattern transformed"]
    F --> G["Going forward<br/>weekly target, not voicemail"]
```
