# Prompt: lint — procedure

> Header + write-contract: **[`lint.md`](lint.md)** — load that first.
> This file is the on-demand body: the full step-by-step procedure you
> follow once you've committed to running `lint`.
