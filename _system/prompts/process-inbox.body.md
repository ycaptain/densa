# Prompt: process-inbox — procedure

> Header + write-contract: **[`process-inbox.md`](process-inbox.md)** —
> load that first. This file is the on-demand body: the full
> step-by-step procedure you follow once you've committed to running
> `process-inbox`.
