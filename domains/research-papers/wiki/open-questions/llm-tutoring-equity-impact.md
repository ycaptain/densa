...
- Empirically, the *positive* learning effects in this domain
  ...
  [[2025-kestin-ai-tutoring-active-learning-summary|Kestin]])
...
- The *negative* learning effects
  ([[2024-bastani-generative-ai-guardrails-summary|Bastani's GPT Base]])
...
- **Awareness gap.**
  [[2024-bastani-generative-ai-guardrails-summary|Bastani §3.4]]
...
| ---------- | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| 2024-09    | [[2024-vanzo-gpt4-homework-tutor-summary]]                          | Single-school positive evidence; cost-of-deployment was a single topic-prompt — **low** authoring cost       |
| 2024-fall  | [[2024-bastani-generative-ai-guardrails-summary]]                   | Negative evidence for the *naive-tool* configuration; positive-but-no-uplift for guardrailed — **high** cost |
| 2025       | [[2025-kestin-ai-tutoring-active-learning-summary]]                 | Strong positive evidence but with **high** authoring cost (physics-education experts wrote the prompt)        |
| 2025-10    | [[2025-kim-chatgpt-education-review-tkl-summary]]                   | Systematic review explicitly names the **economic-barrier mechanism** (paid tier + connectivity + device may exacerbate inequity) and the **geographic-coverage gap** (only 4/52 studies from China, 3 from US; 13/52 — 25% — don't specify country at all) — but **no study in the 52-corpus directly tests cross-resource-tier deployment** |
