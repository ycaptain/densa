...
> reshapes the picture ([[2024-bastani-generative-ai-guardrails-summary|Bastani]],
> [[2025-kestin-ai-tutoring-active-learning-summary|Kestin]]) is
...
>    [[llm-tutoring-systems]] literature ([[2024-bastani-generative-ai-guardrails-summary|Bastani PNAS]],
>    [[2025-kestin-ai-tutoring-active-learning-summary|Kestin Harvard]])
...
causal claims in this domain ([[2024-bastani-generative-ai-guardrails-summary|Bastani 2024]],
...
- **"ChatGPT"-keyword scope.** The review filters explicitly on
  ...
  *engine* behind ChatGPT) that did not name the chat product are
  ...
  and [[2025-kestin-ai-tutoring-active-learning-summary|Kestin et al. 2025]]
...
- [[2024-bastani-generative-ai-guardrails-summary]] — **not in
  ...
  Bastani is missing.
- [[2025-kestin-ai-tutoring-active-learning-summary]] — **not in
  this review's corpus** but the canonical
  pedagogy-aware-tutor positive evidence; same caveat.
- [[2024-vanzo-gpt4-homework-tutor-summary]] — also not in the
