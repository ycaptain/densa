...
```mermaid
flowchart LR
    F["Father dies<br/>2026-02-04<br/>(week 0)"]
    F --> L["Logistics phase<br/>weeks 1-4<br/>functional, no contact with care"]
    L --> S["Symptom emergence<br/>weeks 3-7<br/>3:40 wakings<br/>chest band<br/>two-of-me"]
    S --> P["PCP route<br/>~week 7<br/>PHQ-9=14<br/>cardiac negative"]
