...
as its community standard. The text below is a short summary; the
linked canonical version governs in case of any conflict.

## Our pledge

We pledge to keep this project a welcoming, harassment-free space for
...
- Publishing others' private information (physical address, email,
...
This Code of Conduct applies in all project spaces — issues, pull
requests, discussions, commit messages, and any direct communication
that represents the project. It also applies when an individual is
...
See the canonical text for the full enforcement guidelines.
