...
| AGENTS002 | log-append-only | [AGENTS.md §"Red lines"](../../AGENTS.md#6-red-lines-non-negotiable) (log reverse-chronological append-only) | error | bypass: `WIKI_ALLOW_LOG_REORDER=1` |
...
| AGENTS007 | operation-writes-within-scope | [AGENTS.md §"Operation writes"](../../AGENTS.md#20-operation-writes-machine-enforced-via-agents007) | error | bypass: `WIKI_ALLOW_CROSS_SCOPE=1` |
...
Both bypasses are deliberately narrow. The audit-log pairing
requirement means a bypass leaves a trail; reviewers see at a glance
how often the escape hatch was used and why.
